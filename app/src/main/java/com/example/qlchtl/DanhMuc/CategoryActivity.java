package com.example.qlchtl.DanhMuc;
...
public class CategoryActivity extends AppCompatActivity {
    private QLCHTL_DatabaseHandler productHelper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        productHelper = new QLCHTL_DatabaseHandler(this);
        ...
        loadCategory();
        Button back=findViewById(R.id.btnbackCategory);
